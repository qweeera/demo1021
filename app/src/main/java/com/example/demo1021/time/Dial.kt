...
fun DrawScope.dial1(
    ...
    repeat(12) { steps ->
        ...
        val stepsHeight = dialStyle.fiveStepsLineHeight.toPx()
        ...
        if (true) {
            ...
            if (steps == 0) {
                ...
                stepsLabel = String.format("%02d", steps+12)
            }
...
fun DrawScope.dial2(
    ...
    repeat(12) { steps ->
        ...
        if (true) {
            var stepsLabel = ""
            if (steps == 0) {
                stepsLabel = String.format("%02d", 12)
            } else {
                stepsLabel = String.format("%02d", steps)
            }
            //measure the given label width and height
